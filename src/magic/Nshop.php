...
class Nshop extends PluginBase
{
    ...
    public function relaodAllConfig(){
        $this->MainConfig->relaod();
        $this->ShopConfig->relaod();
        $this->SellConfig->relaod();
        $this->CmdShopConfig->relaod();
        $this->ExpShopConfig->relaod();
        $this->MagicShopConfig->relaod();
        $this->SwitchConfig->relaod();
        $this->SwopShopConfig->relaod();
    }
    /**
     * Get UI API
     * @return mixed
     ...
     * @return bool
     */
    public function onCommand(CommandSender $sender, Command $command, string $label, array $args):bool{//命令Command
